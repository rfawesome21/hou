...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ContentBigBlock".
 */
export interface ContentBigBlock {
  columns?:
    | {
        size?: ('oneThird' | 'half' | 'twoThirds' | 'full') | null;
        richText?: {
...
export interface PagesSelect<T extends boolean = true> {
  ...
  layout?:
    ...
    | {
        ...
        contentBig?: T | ContentBigBlockSelect<T>;
        galleryBlock?:
          | T
          | {
              heading?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ContentBigBlock_select".
 */
export interface ContentBigBlockSelect<T extends boolean = true> {
  columns?:
    | T
    | {
        size?: T;
